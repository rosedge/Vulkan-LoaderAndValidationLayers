...
bool loaderGetDeviceRegistryEntry(const struct loader_instance *inst, char **reg_data, PDWORD total_size, DEVINST devID,
                                  VkResult *result) {
    ...
    // query value
    LSTATUS ret = RegQueryValueEx(hkrKey, HKR_VK_DRIVER_NAME, NULL, NULL, NULL, &requiredSize);
    ...
    ret = RegQueryValueEx(hkrKey, HKR_VK_DRIVER_NAME, NULL, &dataType, pVkDriverPath, &requiredSize);
